export const ACTION_TYPES = {
  GET_BASE_URL: 'Get the base url from which our requests are served',
  GET_BASE_URL_ERROR: 'Error trying to get the base url',
  GET_URLS: 'Get all urls Shortened so far',
